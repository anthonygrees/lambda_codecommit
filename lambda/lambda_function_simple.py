...
def lambda_handler(event, context):
    ...
    try:
        ...
        response1 = '{codecommit: data, repository_http : '+response['repositoryMetadata']['cloneUrlHttp']+', referncces : '+str(references)+', region : '+region+', branch : '+branch+', source_version : '+source_version+', commit_time : '+commit_time+', eventTriggerName : '+eventTriggerName+', userIdentityARN : '+userIdentityARN+'}'
